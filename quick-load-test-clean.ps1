...
Write-Host "`nLoad Test Scripts Available:" -ForegroundColor Cyan
Write-Host "  • .\quick-load-test.ps1      - 1,000 messages (verification)" -ForegroundColor White
...
Write-Host "  • .\full-load-test.ps1       - Complete load test with monitoring" -ForegroundColor White
